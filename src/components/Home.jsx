...
const Home = () => {
  ...
  return (
    <motion.div
      ...
      className='relative bg-[#d0c3f1] pb-20 w-screen h-screen flex flex-col justify-center items-center text-center overflow-hidden'
    >
      {/* Floral Circles */}
      ...
      <div className='relative z-10'>
        <h1 className='text-[white] text-3xl sm:text-7xl pb-2'>Product <span className='text-[#40e0d0]'>Designer</span> </h1>
        <h1 className='text-white text-3xl sm:text-7xl pt-2'> <span className='text-[#40e0d0]'>Building</span> Things</h1>
